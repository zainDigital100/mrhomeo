      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              {[
                { icon: Heart, label: "Compassionate Care", desc: "Treating every person with empathy" },
                { icon: Leaf, label: "Natural Approach", desc: "Gentle, holistic remedies" },
                { icon: Brain, label: "AI Powered", desc: "Intelligent symptom analysis" },
                { icon: Shield, label: "Safe & Ethical", desc: "Your safety comes first" }
              ].map((item, index) => (
                <motion.div
                  key={item.label}
                  variants={fadeInUp}
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              {[
                "We never claim to be a replacement for licensed medical professionals",
                "We never guarantee cures or make promises about health outcomes",
                "We do not handle medical emergencies—always call emergency services",
                "We recommend professional consultation for serious symptoms",
                "We use educational, informative language—never prescriptive",
                "We protect your privacy and never share personal health data",
                "We clearly label all information as educational, not medical advice",
                "We encourage users to verify information with healthcare providers"
              ].map((item, index) => (
                <motion.div
                  key={index}
                  variants={fadeInUp}
